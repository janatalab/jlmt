...
data_list = {...
    ...
    fullfile(priv_path,'jlmt','maps','pp2pictchclass_W_20121105.mat'),...
...
pathRep = {fullfile(pub_path,'database'),'utils';...
       ...
       '/data2/tonmodcomp/closure_work/closure_final','data/maps';...
