...
data_list = {...
    ...
    '/data2/modulation/cont_popout/pp2pitchclass_nnet_full_20120418T220430.mat',...
    '/data2/tonmodcomp/modorig/som/pc_ci2toract_map_12-Jun-2012_15:47.mat',...
    '/data2/tonmodcomp/closure_work/closure_struct/closure_struct-20120710T153125.mat',...
    '/data2/tonmodcomp/closure_work/closure_struct/closure_struct-20120703T111311.mat',...
    '/data2/tonmodcomp/bigand_etal_jep_2003/B_I_NTC.wav',...
    '/data2/tonmodcomp/bigand_etal_jep_2003/B_IV_NTC.wav',...
    '/data2/tonmodcomp/marmel_and_tillmann_mp_2009/Riii0.mp3',...
    '/data2/tonmodcomp/marmel_and_tillmann_mp_2009/Rvii0.mp3',...
    '/data2/tonmodcomp/marmel_etal_jep_2010/piano1MiF.wav',...
    '/data2/tonmodcomp/marmel_etal_jep_2010/piano2BivF.wav',...
    '/data2/tonmodcomp/marmel_etal_jep_2010/pure1AiF.wav',...
    '/data2/tonmodcomp/marmel_etal_jep_2010/pure2AivF.wav',...
    '/data2/tonmodcomp/marmel_etal_pp_2008/Gi.wav',...
    '/data2/tonmodcomp/marmel_etal_pp_2008/Giv.wav',...
    '/data2/tonmodcomp/tillmann_etal_cbr_2003/1RCinBB.wav',...
    '/data2/tonmodcomp/tillmann_etal_cbr_2003/1RCinCB.wav',...
    '/data2/tonmodcomp/tillmann_etal_cbr_2003/3UCinBB.wav',...
    '/data2/tonmodcomp/tillmann_etal_cbr_2003/3UCinCB.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2003/C_I_baseline_cons.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2003/C_I_cons.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2003/C_IV_baseline_cons.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2003/C_IV_cons.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2008/CD.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2008/CDb.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2008/CS.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2008/CSb.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2008/CT.wav',...
    '/data2/tonmodcomp/tillmann_etal_jep_2008/CTb.wav',...
...
pathRep = {fullfile(pub_path,'database'),'utils';...
       ...
       '/data2/tonmodcomp/closure_work/closure_struct','data/maps';...
